...
class ImgCRUD extends Component {
    ...
    async uploadFile(file){
        ...
        return await axios.post('http://ishowcase.epizy.com/php/imgupload.php?id='+this.props.obj, formData, {
            headers: {
    ...
    async uploadFileOther(file){
        ...
        return  await axios.post('http://ishowcase.epizy.com/php/imguploadtwo.php?id='+this.props.obj, formData2, {
            headers: {
                'content-type': 'multipart/form-data'
            }
        });
    ...
    // GET OTHER IMAGES
    componentDidMount() {
        axios.get('http://ishowcase.epizy.com/php/imglist.php?id='+this.props.obj)
        .then(response => {
    ...
    deleteImg(id) {
        if(window.confirm("Are you sure you want to delete this image?")) {
            axios.get('http://ishowcase.epizy.com/php/deleteimg.php?id='+id)
            .then(
            ...
            <div className="imgcrud">
                ...
                <div className="uploadedimg"> 
                    { this.state.otherimgs ? this.state.otherimgs.map(imgs => {
                        return (<div className="upimgs" key={imgs.name}><img src={ "http://ishowcase.epizy.com/php/uploads/"+imgs.name } alt="img"></img><br></br>
