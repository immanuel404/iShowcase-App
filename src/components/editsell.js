...
class Editsell extends Component {
    ...
    // GET DATA
    componentDidMount() {
        axios.get('http://ishowcase.epizy.com/php/getbyid.php?id='+this.props.match.params.id)
        .then(response => {
            this.setState({
    ...
    imgGet(){
        if(this.state.img ){
            return <img className="imgget" src={ "http://ishowcase.epizy.com/php/uploads/"+this.state.img } alt="img"></img>
        }
    }
    ...
    onSubmit(e) {
      ...
      if(session === check){
            ...
            const obj = {
                ...
                axios.post('http://ishowcase.epizy.com/php/selledit.php?id='+
    ...
    deleteItem() {
      ...
      if(session === check){
        if(window.confirm("Are you sure you want to delete this product/item?")) {
            axios.get('http://ishowcase.epizy.com/php/deletesell.php?id=' +this.props.match.params.id)
            .then(
    ...
    styleChange(){
      ...
      if(session === check){
        ...
        axios.post('http://ishowcase.epizy.com/php/styleChange.php?id='+this.props.match.params.id, style)
        .then(res => res.data);
    ...
    if (this.state.redirect) {
      return window.location.assign('http://ishowcase.epizy.com/');
    }
