...
class Createsell extends Component {
    ...
    constructor(props){
     ...
     componentDidMount() {
        ...
        axios.get('http://ishowcase.epizy.com/php/imglist.php?id='+this.props.match.params.id)
        .then(response => {
     ...
     imgGet(){
        ...
        if(this.state.img ){
            return <img src={ "http://ishowcase.epizy.com/php/uploads/"+this.state.img } alt="img"></img>
        }
     }
     ...
     imageList(){
         if(this.state.imglist){
            return this.state.imglist.map((img, i) => {
                if(img.name){
                    return <div className="imglist" key={i}><img src={ "http://ishowcase.epizy.com/php/uploads/"+img.name } alt="img"></img></div>
                } else {return null}
            })
        }
     }
